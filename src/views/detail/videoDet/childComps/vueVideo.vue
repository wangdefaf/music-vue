<template>
  <div id="video">
    ...
    <div id="videoInfo">
      <div class="left">
        <h1 :title="videoDet.desc">{{ videoDet.description }}</h1>
        <span>播放量: {{ $store.getters.playCount(videoDet.playTime) }}</span>
      </div>
      <div class="right">
        <div class="like">
          <i></i>
        ...
        <div class="comment">
          <a>
            <span>{{ videoDet.commentCount }}</span>
          </a>
        </div>
      </div>
    </div>
